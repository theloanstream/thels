...
def sell_collateral_uni_usdc(thels: Contract, token: str, amount: int, account=get_account()):
    ...
    qty = 1 * 10 ** 18 # idk what it is, but it was in the example with buying VXV with ETH
